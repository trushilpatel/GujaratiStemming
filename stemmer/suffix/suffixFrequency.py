def suffix_word_frequency(file_path):
    ...
    write_suffix_frequency_file = open('suffix_frequency.txt', 'wt', encoding='utf-8')
...
if __name__ == '__main__':
    suffix_word_frequency(r'D:\MY\GIT\Gujarati-Stemming\StemmingOutput\unique_words.txt')